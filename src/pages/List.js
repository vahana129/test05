  ...
  return (
    <div>
      ...
      <Ul className='list-wrap'>
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/01.jpg`} alt="회차 썸네일01" />
          <h3>1. 1화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/02.jpg`} alt="회차 썸네일02" />
          <h3>2. 2화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/03.jpg`} alt="회차 썸네일03" />
          <h3>3. 3화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/04.jpg`} alt="회차 썸네일04" />
          <h3>4. 4화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/05.jpg`} alt="회차 썸네일05" />
          <h3>5. 5화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/06.jpg`} alt="회차 썸네일06" />
          <h3>6. 6화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/07.jpg`} alt="회차 썸네일07" />
          <h3>7. 7화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/08.jpg`} alt="회차 썸네일08" />
          <h3>8. 8화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/09.jpg`} alt="회차 썸네일09" />
          <h3>9. 9화</h3>
          <p>
        ...
        <Li>
          <img src={`${process.env.PUBLIC_URL}/images/10.jpg`} alt="회차 썸네일10" />
          <h3>10. 10화</h3>
          <p>
